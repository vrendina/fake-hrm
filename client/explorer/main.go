...
var (
	...
	addr   = flag.String("addr", "7a9ecd6522743880f364caabf6c39ef8", "address of remote peripheral (MAC on Linux, UUID on OS X)")
	sub    = flag.Duration("sub", 0 * 1e9, "subscribe to notification and indication for a specified period")
